...
public class HiyaWordArrSpout extends BaseRichSpout
{
	 ...
	 */
	@Override
	public void open(@SuppressWarnings("rawtypes") Map map, TopologyContext arg1, SpoutOutputCollector collector)
	{
