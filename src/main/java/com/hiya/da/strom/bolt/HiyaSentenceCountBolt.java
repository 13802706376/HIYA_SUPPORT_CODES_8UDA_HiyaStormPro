package com.hiya.da.strom.bolt;
 ...
 *
 */
public class HiyaSentenceCountBolt extends BaseRichBolt
{
	private static final long serialVersionUID = 4645656661L;
	 ...
	 * 会抛出NotSerializableException并且拓扑将无法发布。 本例中因为HashMap 是可序列化的,所以可以安全地在构造函数中实例化。
	 * 但是，通常情况下最好是在构造函数中对基本数据类型和可序列化的对象进行复制和实例化 而在prepare()方法中对不可序列化的对象进行实例化。
	 */
