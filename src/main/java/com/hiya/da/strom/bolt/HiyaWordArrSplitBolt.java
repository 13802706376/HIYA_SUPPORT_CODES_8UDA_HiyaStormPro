...
public class HiyaWordArrSplitBolt extends BaseRichBolt
{
	 ...
	 */
	@Override
	public void prepare(@SuppressWarnings("rawtypes") Map map, TopologyContext arg1, OutputCollector collector)
	{
