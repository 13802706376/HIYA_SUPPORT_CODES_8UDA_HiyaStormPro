...
import com.hiya.da.strom.bolt.HiyaSentenceCountBolt;
import com.hiya.da.strom.bolt.HiyaSentenceReportBolt;
import com.hiya.da.strom.bolt.HiyaSentenceSplitBolt;
import com.hiya.da.strom.spout.HiyaSentenceSpout;

/**
 * 实现单词计数topology
 *
 */
public class HiyaSentenceTopology
{
	...
	{
		HiyaSentenceSpout spout = new HiyaSentenceSpout();
		HiyaSentenceSplitBolt splitBolt = new HiyaSentenceSplitBolt();
		HiyaSentenceCountBolt countBolt = new HiyaSentenceCountBolt();
		HiyaSentenceReportBolt reportBolt = new HiyaSentenceReportBolt();
		...
		// builder.setBolt(COUNT_BOLT_ID, countBolt).fieldsGrouping( SPLIT_BOLT_ID, new
		// Fields("word"));
